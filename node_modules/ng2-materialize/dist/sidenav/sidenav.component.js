...
MzSidenavComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [".side-nav.fixed.right-aligned{box-shadow:-2px 0 2px 0 rgba(0,0,0,.14),-1px 0 5px 0 rgba(0,0,0,.12),-3px 0 1px -2px rgba(0,0,0,.2)}.side-nav.fixed:not(.right-aligned){box-shadow:2px 0 2px 0 rgba(0,0,0,.14),1px 0 5px 0 rgba(0,0,0,.12),3px 0 1px -2px rgba(0,0,0,.2)}"],
            },] },
];
/** @nocollapse */
